...
export const MOCK_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "RSCの実装パターンとパフォーマンス改善の実例を整理しました。Client / Server 境界の設計が鍵になります。",
    ...
    tags: [{ id: "react", name: "React" }, { id: "nextjs", name: "Next.js" }, { id: "ts", name: "TypeScript" }],
  },
  {
    id: "hono-cloudflare-workers",
    title: "Hono × Cloudflare Workers でゼロコールドスタート API を作る",
    excerpt: "エッジランタイムの力を活かした超高速 API の構築方法。Lambda との比較コストも検証しました。",
    ...
    tags: [{ id: "hono", name: "Hono" }, { id: "cloudflare", name: "Cloudflare" }, { id: "backend", name: "Backend" }],
  },
  {
    id: "typescript-strict-mode",
    title: "TypeScript strict モードで得られる恩恵と向き合い方",
    excerpt: "noUncheckedIndexedAccess や exactOptionalPropertyTypes など、strict 以上の設定で型安全性を極める。",
    ...
    tags: [{ id: "ts", name: "TypeScript" }, { id: "tips", name: "Tips" }],
  },
  {
    id: "docker-multi-stage",
    title: "Docker マルチステージビルドで本番イメージを 1/10 に圧縮",
    excerpt: "node_modules を抱えた 2GB イメージを 200MB 以下にした実践的な手順とその考え方。",
    ...
    tags: [{ id: "docker", name: "Docker" }, { id: "infra", name: "Infra" }],
  },
  {
    id: "supabase-realtime",
    title: "Supabase Realtime で作るライブダッシュボード",
    excerpt: "PostgreSQL の変更をリアルタイムに購読し、WebSocket 不要でライブ更新 UI を実装する方法。",
    ...
    tags: [{ id: "supabase", name: "Supabase" }, { id: "react", name: "React" }],
  },
  {
    id: "aws-lambda-hono",
    title: "AWS Lambda × Hono で作るサーバーレス API の設計パターン",
    excerpt: "Lambda の関数 URL と Hono を組み合わせた軽量サーバーレスバックエンドの実装と落とし穴。",
    ...
    tags: [{ id: "aws", name: "AWS" }, { id: "hono", name: "Hono" }, { id: "serverless", name: "Serverless" }],
  },
];
